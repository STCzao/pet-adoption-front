...
const AdopcionesPage = (cerrarSesion) => {
  ...
  return (
    <div>
      ...
      <div
        className="w-full min-h-screen text-white flex flex-col md:flex-row items-center justify-between px-4 md:px-16 py-40"
        style={{
      ...
      <div className="bg-[#e6dac6] flex flex-col items-center gap-5 font-medium">
        ...
        <div className="mb-15 grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-10 px-4">
          {loading ? (
